...
class _UrlShortenerFormState extends State<UrlShortenerForm> with SingleTickerProviderStateMixin {
  ...
  void _onUrlChanged() {
    ...
    try {
      ...
      final isValid = uri.isAbsolute && (uri.scheme == 'http' || uri.scheme == 'https');
      setState(() {
        _isValidUrl = isValid;
        _errorMessage = isValid ? null : 'Please enter a valid URL starting with http:// or https://';
      });
    } catch (e) {
      setState(() {
        _isValidUrl = false;
                              ...
                              Row(
                                ...
                                children: [
                                  TextButton.icon(
                                    ...
                                    label: Text(isMobile ? 'New URL' : 'Create Another'),
                                  ),
                                ],
                              ),
                            ],
  ...
  @override
  Widget build(BuildContext context) => _buildFormView();
}
